...
public class AABRR_Aleatoire {
	 ...
	 * @param q : Valeur max des donn�es de l'arbre, doit etre > 1
	 * @return retourne l'arbre aabrr g�n�r�
	 */
	public AABRR Generation(int p, int q) {
		...
		if( p > 1 && q > 1) {
			...
			//cr�er une pile pour cr�er l'arbre
			...
			//on parcours le AABRR pour fixer les valeurs min max et cr�er le ABRR
			current_min = 0;
